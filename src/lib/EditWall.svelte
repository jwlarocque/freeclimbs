...
<form>
	...
	{:else}
		<p class="minor">
			This wall will be restricted to people you share a link with. Site admins will still be able
			to see your wall.
			<br />
			You can change this setting at any time.
		</p>
	...
	/>
	<p class="minor">
		Whether we may use images of this wall to train machine learning models. Datasets containing
		your images and models we train with them will always be free and public.
		<br />
		You can change this setting at any time, but doing so will only affect future training datasets we
		create from that point on.
	</p>
	<button
		class="submit buttonDarkInverse"
		disabled={!submitEnabled || awaitingSave}
...
<div class="danger">
	<ConfirmModal
		buttonText="Delete Wall"
		buttonClass="buttonDeleteInverse"
